...
export default function ServerList({ error }: Props) {
  ...
  return (
    <>
      <div className="w-[72px] bg-claude-surfaceDark text-claude-onDark flex flex-col items-center py-3 gap-2 overflow-y-auto shrink-0 border-r border-claude-surfaceDarkElevated relative z-10">
        {error && (
        ...
        <div className="mt-auto flex flex-col items-center gap-2 pt-3 border-t border-claude-surfaceDarkElevated w-full">
          <button
            ...
            className="w-12 h-12 rounded-claudeLg border border-dashed border-claude-surfaceDarkSoft flex items-center justify-center text-claude-onDarkSoft hover:text-claude-onDark hover:border-claude-primary transition-colors text-xl font-light mb-1"
            title="Join a server"
          >
            +
          </button>
